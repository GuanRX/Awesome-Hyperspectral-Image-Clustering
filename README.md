...
5. [TCSVT 2026] **Integrating Pseudo-Supervision and Spatial Constraints for Efficient Clustering of Multimodal Remote Sensing Data** \[[paper](https://ieeexplore.ieee.org/document/11506437)]
6. [IF 2026] **Aligned anchors and cluster-structure guided fusion for multimodal remote sensing clustering** \[[paper](https://www.sciencedirect.com/science/article/abs/pii/S1566253526003556)]
7. [TGRS 2026] **Learning Nonlinear Flow Matching for Multimodal Remote Sensing Image Clustering** \[[paper](https://ieeexplore.ieee.org/document/11569100)]
8. [TGRS 2026] **Efficient One-Step Orthogonal Consensus Framework for Multiview Remote Sensing Clustering** \[[paper](https://ieeexplore.ieee.org/abstract/document/11404236)]
9. [TGRS 2026] **A Semantic Transformer for Self-Supervised Deep Clustering of Large Hyperspectral Images** \[[paper](https://ieeexplore.ieee.org/abstract/document/11494144)]
10. [TGRS 2026] **DSGC: Dynamic Sparse Graph Constrained Autoencoder for Hyperspectral Image Clustering** \[[paper](https://ieeexplore.ieee.org/abstract/document/11570225)]
11. [PR 2026] **Multi-view subspace approach with superpixel meta-samples and relational-consistency contrastive learning for unsupervised PolSAR image classification** \[[paper](https://www.sciencedirect.com/science/article/abs/pii/S0031320326007545)]
12. [JSTARS 2026] **Superpixel-Level Hypergraph Regularized Multi-View Clustering for Hyperspectral Images** \[[paper](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=11433595)]
13. [JSTARS 2026] **Contrastive Prototype Clustering for Multimodal Remote Sensing Data Based on Spectral–Spatial Cross Mamba** \[[paper](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=11397521)]
14. [JSTARS 2026] **Spectral-Structure Enhanced Multi-Subview Contrastive Clustering for Hyperspectral Images** \[[paper](https://ieeexplore.ieee.org/document/11424285?denied=)]
15. [Neurocomputing 2026] **Efficient superpixel-guided global-local spectral clustering for large-scale HSI** \[[paper](https://www.sciencedirect.com/science/article/abs/pii/S0925231226005874)]
16. [Remote Sensing 2026] **Multimodal Remote Sensing Image Clustering on Superpixel Manifolds** \[[paper](https://www.mdpi.com/2072-4292/18/6/939)]
17. [Scientific Reports 2026] **Anchor-guided multi-view fuzzy clustering for hyperspectral and LiDAR images** \[[paper](https://www.nature.com/articles/s41598-026-40213-2)]
18. [ICASSP 2025] **Clustering of Multisource Remote Sensing Data via Low-Rank Tensor Learning with Spatial Constraints** \[[paper](https://ieeexplore.ieee.org/abstract/document/11462722)]
19. [ICASSP 2025] **Joint Superpixel and Self-Representation Learning for Scalable Hyperspectral Image Clustering** \[[paper](https://ieeexplore.ieee.org/document/11464647)]
20. [Arxiv] **Unbalanced Optimal Transport Dictionary Learning for Unsupervised Hyperspectral Image Clustering** \[[paper](https://arxiv.org/pdf/2603.10132)]
21. [Arxiv] **Deep Spatially-Regularized and Superpixel-Based Diffusion Learning for Unsupervised Hyperspectral Image Clustering** \[[paper](https://arxiv.org/pdf/2604.13307)]
