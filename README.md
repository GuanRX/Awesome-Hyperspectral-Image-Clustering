...
5. [TGRS 2026] **A Semantic Transformer for Self-Supervised Deep Clustering of Large Hyperspectral Images** \[[paper](https://ieeexplore.ieee.org/abstract/document/11494144)]
6. [JSTARS 2026] **Superpixel-Level Hypergraph Regularized Multi-View Clustering for Hyperspectral Images** \[[paper](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=11433595)]
7. [JSTARS 2026] **Contrastive Prototype Clustering for Multimodal Remote Sensing Data Based on Spectral–Spatial Cross Mamba** \[[paper](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=11397521)]
8. [JSTARS 2026] **Spectral-Structure Enhanced Multi-Subview Contrastive Clustering for Hyperspectral Images** \[[paper](https://ieeexplore.ieee.org/document/11424285?denied=)]
